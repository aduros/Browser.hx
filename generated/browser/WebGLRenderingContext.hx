...
extern class WebGLRenderingContext extends CanvasRenderingContext
{
    ...
    function uniformMatrix2fv (location :WebGLUniformLocation, transpose :Bool, array :Float32Array) :Void;

    function uniformMatrix3fv (location :WebGLUniformLocation, transpose :Bool, array :Float32Array) :Void;

    function uniformMatrix4fv (location :WebGLUniformLocation, transpose :Bool, array :Float32Array) :Void;
